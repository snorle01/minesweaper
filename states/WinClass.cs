...
public class WinClass : StateClass
{
    GameClass prev_state;
    Texture2D fade_texture;
    SpriteFont font;
    ButtonControler buttons;
    public WinClass(Game1 game, ContentManager content, GraphicsDevice graphics_device, GameClass prev_state) : base(game, content, graphics_device) {
    ...
    public override void draw(SpriteBatch sprite_batch) {
        ...
        sprite_batch.DrawString(font, "WIN", new Vector2(100, 100), Color.White);
